...
# # 1️⃣ Create Qdrant collection (only once)
...
# docs = [
#     {"id": 1, "text": "Qdrant is an open-source vector database designed for fast similarity search."},
#     {"id": 2, "text": "Retrieval-Augmented Generation (RAG) improves LLM responses using external context."},
#     {"id": 3, "text": "OpenAI provides embeddings models such as text-embedding-3-small and text-embedding-3-large."}
# ]
...
def search_with_context(query: str) -> str:
    return f"Searching Qdrant and OpenAI for: {query}"

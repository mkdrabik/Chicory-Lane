...
<qgis hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" labelsEnabled="0" simplifyAlgorithm="0" minScale="1e+08" simplifyMaxScale="1" version="3.10.11-A Coruña" styleCategories="AllStyleCategories" simplifyDrawingHints="1" simplifyLocal="1" maxScale="0" readOnly="0">
  ...
  <renderer-v2 attr="Baseline River Type" symbollevels="0" enableorderby="0" type="categorizedSymbol" forceraster="0">
    <categories>
      <category label="Canals" value="Canals" render="true" symbol="0"/>
      <category label="Culvert" value="Culvert" render="true" symbol="1"/>
      <category label="Ditches" value="Ditches" render="true" symbol="2"/>
      <category label="Other Rivers and Streams" value="Other Rivers and Streams" render="true" symbol="3"/>
      <category label="Priority Habitat" value="Priority Habitat" render="true" symbol="4"/>
    </categories>
    <symbols>
      <symbol type="line" force_rhr="0" name="0" clip_to_extent="1" alpha="1">
        ...
        <layer class="MarkerLine" pass="0" enabled="1" locked="0">
          ...
          <symbol type="marker" force_rhr="0" name="@0@2" clip_to_extent="1" alpha="1">
        ...
        <layer class="MarkerLine" pass="0" enabled="1" locked="0">
          ...
          <symbol type="marker" force_rhr="0" name="@0@3" clip_to_extent="1" alpha="1">
            <layer class="SimpleMarker" pass="0" enabled="1" locked="0">
              <prop k="angle" v="0"/>
              <prop k="color" v="0,197,255,255"/>
              <prop k="horizontal_anchor_point" v="1"/>
      ...
      <symbol type="line" force_rhr="0" name="3" clip_to_extent="1" alpha="1">
        ...
        <layer class="MarkerLine" pass="0" enabled="1" locked="0">
          ...
          <symbol type="marker" force_rhr="0" name="@3@2" clip_to_extent="1" alpha="1">
            <layer class="SimpleMarker" pass="0" enabled="1" locked="0">
              <prop k="angle" v="0"/>
        ...
        <layer class="MarkerLine" pass="0" enabled="1" locked="0">
          ...
          <symbol type="marker" force_rhr="0" name="@3@3" clip_to_extent="1" alpha="1">
            <layer class="SimpleMarker" pass="0" enabled="1" locked="0">
              <prop k="angle" v="0"/>
              <prop k="color" v="255,255,255,255"/>
              <prop k="horizontal_anchor_point" v="1"/>
